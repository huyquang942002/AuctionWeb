...
<html>
  ...
  <body>
    <font size="6" color="green">Danh sách đấu giá ：</font><br>
    <div>
...
<%--                      <img src="<%=path+"/"+user.getUser_icon().toString()%>" width=100% height=100% style="border-radius:200px;"> --%>
                     ...
                     <% long Ms=myGoodss.get(i).getDate().getTime();
	                  ...
	                  %>
                     <font color="#f4e465" size="5px">Bắt đầu :<%=myFmt.format(Ms)%></font>
                     <font color="#000" size="5px"> Kết thúc :<%=myFmt.format(TotalMS)%></font>
                     </div>
                  </div>
                  <div style="width:100%;">
