...
CREATE TABLE `t_book`  (
  ...
  `category` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'book',
...
CREATE TABLE `t_category`  (
  ...
  `describe` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of t_order
-- ----------------------------
INSERT INTO `t_order` VALUES (1, 1, 3200.00, 1, 1, '2019-05-15 18:46:20', 'book');
...
CREATE TABLE `t_stamp`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `user_id` int NOT NULL,
  `category` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'stamp',
  `winner_id` int NULL DEFAULT NULL,
  `max_price` decimal(10, 2) NOT NULL DEFAULT 0.00,
  `price` decimal(10, 2) NULL DEFAULT NULL,
  `introduce` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- Records of t_stamp
-- ----------------------------
INSERT INTO `t_stamp` VALUES (1, 1, 'stamp', 1, 0.00, 3560.00, 'Tem đẹp', 'img/stamp/tem1.jpg', '2019-06-04 00:58:41', 1);
INSERT INTO `t_stamp` VALUES (2, 1, 'stamp', 1, 0.00, 605.00, 'Tem đẹp', 'img/stamp/tem2.jpg', '2019-06-02 01:34:09', 1);
INSERT INTO `t_stamp` VALUES (3, 1, 'stamp', 1, 0.00, 85.00, 'Tem đẹp', 'img/stamp/tem3.jpg', '2019-06-03 01:36:31', 1);
INSERT INTO `t_stamp` VALUES (4, 1, 'stamp', 1, 0.00, 56.00, 'Tem đẹp', 'img/stamp/tem4.jpg', '2019-06-04 01:37:32', 1);
INSERT INTO `t_stamp` VALUES (5, 1, 'stamp', 1, 0.00, 47.00, 'Tem đẹp', 'img/stamp/tem5.jpg', '2019-06-01 01:39:07', 1);
...
CREATE TABLE `t_watch`  (
  ...
  `user_id` int NOT NULL,
  `category` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'watch',
  `winner_id` int NULL DEFAULT NULL,
  `max_price` decimal(10, 2) NOT NULL DEFAULT 0.00,
  `price` decimal(10, 2) NULL DEFAULT NULL,
...
-- Records of t_watch
-- ----------------------------
INSERT INTO `t_watch` VALUES (2, 1, 'watch', 0, 0.00, 2300.00, 'OysterDate Precision - 6694- 1960-1969', 'img/watch/app1.jpg', '2019-06-04 15:30:29', 1);
INSERT INTO `t_watch` VALUES (3, 3, 'watch', 0, 0.00, 459.00, 'Eterna - Artena Lady - 2510.41.45.0273 - 女士 - 2011至现在', 'img/watch/app2.jpg', '2019-06-05 15:30:29', 1);
INSERT INTO `t_watch` VALUES (4, 3, 'watch', 0, 0.00, 2068.00, 'Rapport London - Paramount Nine Watch Winder - W409 - 中性 - 2011至现在', 'img/watch/app3.jpg', '2019-06-01 15:30:29', 1);
INSERT INTO `t_watch` VALUES (5, 2, 'watch', 0, 0.00, 2681.00, 'Chopard - St Moritz Gold/Steel - 8024 - 女士 - 2000-2010', 'img/watch/app4.jpg', '2019-06-02 15:30:29', 1);
...
CREATE TABLE `t_wine`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `user_id` int NOT NULL,
  `category` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'wine',
  `winner_id` int NULL DEFAULT NULL,
  `max_price` decimal(10, 2) NOT NULL DEFAULT 0.00,
  `price` decimal(10, 2) NULL DEFAULT NULL,
  `introduce` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
